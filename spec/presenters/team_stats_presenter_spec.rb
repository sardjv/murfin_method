    ...
    context 'within filter time range' do
      describe 'average_weekly_planned_per_month' do
        it 'returns average weekly planned values for the time range' do
          ...
          expect(subject.average_weekly_planned_per_month).to eq(
            [
              { 'name': '2019-06-01T00:00:00.000Z', 'value': 397, 'notes': '[]' },
              { 'name': '2019-07-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2019-08-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2019-09-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2019-10-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2019-11-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2019-12-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2020-01-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2020-02-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2020-03-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2020-04-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2020-05-01T00:00:00.000Z', 'value': 2380, 'notes': '[]' },
              { 'name': '2020-06-01T00:00:00.000Z', 'value': 2063, 'notes': '[]' }
            ]
          )
        end
      end
      ...
      describe 'weekly_percentage_delivered_per_month' do
        ...
        it 'returns the percentage delivered over the time range, with any notes' do
          ...
          expect(subject.weekly_percentage_delivered_per_month).to eq(
            [
              { 'name': '2019-06-01T00:00:00.000Z', 'value': 44.08, 'notes': '[]' },
              { 'name': '2019-07-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2019-08-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2019-09-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2019-10-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2019-11-01T00:00:00.000Z', 'value': 50.13, 'notes': [n1, n2].map(&:with_author).to_json },
              { 'name': '2019-12-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2020-01-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2020-02-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2020-03-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2020-04-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2020-05-01T00:00:00.000Z', 'value': 50.13, 'notes': '[]' },
              { 'name': '2020-06-01T00:00:00.000Z', 'value': 49.39, 'notes': '[]' }
            ]
          )
        end
      end
