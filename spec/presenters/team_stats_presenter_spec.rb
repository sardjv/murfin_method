      ...
      describe 'average_weekly_planned_per_month' do
        it 'returns average weekly planned values for the time range' do
          ...
          expect(subject.average_weekly_planned_per_month).to eq(
            [
              { 'name': '2019-06-01T00:00:00.000Z', 'value': 0, 'notes': '[]' },
              { 'name': '2019-07-01T00:00:00.000Z', 'value': 2710, 'notes': '[]' },
              { 'name': '2019-08-01T00:00:00.000Z', 'value': 2168, 'notes': '[]' },
              { 'name': '2019-09-01T00:00:00.000Z', 'value': 2800, 'notes': '[]' },
              { 'name': '2019-10-01T00:00:00.000Z', 'value': 2168, 'notes': '[]' },
              { 'name': '2019-11-01T00:00:00.000Z', 'value': 2240, 'notes': '[]' },
              { 'name': '2019-12-01T00:00:00.000Z', 'value': 2710, 'notes': '[]' },
              { 'name': '2020-01-01T00:00:00.000Z', 'value': 2168, 'notes': '[]' },
              { 'name': '2020-02-01T00:00:00.000Z', 'value': 2317, 'notes': '[]' },
              { 'name': '2020-03-01T00:00:00.000Z', 'value': 2710, 'notes': '[]' },
              { 'name': '2020-04-01T00:00:00.000Z', 'value': 2240, 'notes': '[]' },
              { 'name': '2020-05-01T00:00:00.000Z', 'value': 2168, 'notes': '[]' },
              { 'name': '2020-06-01T00:00:00.000Z', 'value': 2240, 'notes': '[]' }
            ]
          )
        end
      end
      ...
      describe 'weekly_percentage_delivered_per_month' do
        ...
        it 'returns the percentage delivered over the time range, with any notes' do
          ...
          expect(subject.weekly_percentage_delivered_per_month).to eq(
            [
              { 'name': '2019-06-01T00:00:00.000Z', 'value': 0, 'notes': '[]' },
              { 'name': '2019-07-01T00:00:00.000Z', 'value': 44.02, 'notes': '[]' },
              ...
              { 'name': '2020-03-01T00:00:00.000Z', 'value': 44.02, 'notes': '[]' },
              { 'name': '2020-04-01T00:00:00.000Z', 'value': 53.26, 'notes': '[]' },
              { 'name': '2020-05-01T00:00:00.000Z', 'value': 55.03, 'notes': '[]' },
