...
describe 'User edits a plan', type: :feature, js: true do
  ...
  describe 'signoffs' do
    ...
    let!(:lead_membership3) { create :membership, user_group: user_group2, user: user3, role: 'lead' } # other user' group
    ...
    it "shows user group' leads ordered first in the select options" do
      ...
      within 'div.dropdown-menu.show' do
        within 'ul.dropdown-menu.inner.show' do
