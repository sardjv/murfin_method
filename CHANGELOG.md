...
### Added
- API allow create plans
- API allow create activities from schedule
...
- Replace Auth0 API Token with JWT token that can be generated by admins

### Added

- Remember chart and filter settings as move around pages
- Individual chart and data table

### Fixed

- Job Plan bug whereby selected activity categorisation was lost after validation error
- Fix for ActiveRecord::RecordNotUnique when save more than one user without an epr_uuid

## [0.10.0] - 2021-03-16

### Changed

- Use HAML instead of ERB templates
